...
//        }
    ...
    @Override
    public PagedResponse<PhongResponse1> searchRoomManager2(int page, int size, String tenLoaiPhong) {
        Pageable pageable = PageRequest.of((page - 1), size, Sort.Direction.DESC, "id");
        Page<Phong> entities = phongRepository.searchRoomManager2(pageable, tenLoaiPhong);
